    ...
    <div className="login">
      ...
      <div className="login-form">
        ...
        <div className="login-title">
          <svg width="108px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000">
          ...
          <span style={{ fontWeight: 'bold', fontFamily: 'Roboto, sans-serif', fontSize: '40px' }}>Gobler</span>
        </div>
